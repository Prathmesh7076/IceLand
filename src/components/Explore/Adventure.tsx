    ...
    <section className="relative w-full min-h-screen bg-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 pt-20 pb-24">
        ...
        <div className="text-center mb-16">
          ...
          >
            For the experienced skier who finds the lift lines stifling. We take you beyond the boundaries <br/>  into the Rohtang range, where the powder is deep and the silence is absolute.
          </p>
        </div>

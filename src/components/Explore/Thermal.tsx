...
import bgImg from "@/assets/THERMALMASTERY BACK.jpg"; 
import polaroidImg from "@/assets/Explore patalsu peak.jpg"; 
    ...
    <section className="relative w-full min-h-screen bg-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 pt-20 pb-24">
        ...
        <div className="text-center mb-16">
          ...
          <p
            style={{ fontFamily: "'Lato', sans-serif", fontWeight: 700, fontSize: "20px" }}
            className="text-[#0D1926] normal-case tracking-wide mb-4"
          >
            See the valley as the eagles do
          </p>
          <p
            style={{ fontFamily: "'Lato', sans-serif", fontSize: "18px" }}
            className="text-[#0D1926] max-w-3xl mx-auto leading-relaxed"
          >
            We don&apos;t sell &quot;joyrides.&quot; We sell the experience of flight. High-altitude paragliding with <br className="hidden md:block" />
            pilots who understand the Solang thermals better than anyone in the country.
          </p>
        </div>

        {/* MAIN VISUAL GRID: Glass box on LEFT, Image on RIGHT */}
        <div className="flex flex-col lg:flex-row justify-center items-center gap-10 md:gap-16 max-w-5xl mx-auto mt-6">

          {/* LEFT: Frosted Glass Banner with Button */}
          <div
            // Applied exactly the provided CSS glass effect via Tailwind classes
            ...
            style={{ 
              width: '450px', 
              height: '220px',
              WebkitBackdropFilter: 'blur(20px)' // ensuring safari support for the blur
            }}
          >
            <div className="relative z-10 flex flex-col items-center text-center">
              <h3 
                className="text-white uppercase mb-2 drop-shadow-md text-3xl" 
                style={{ fontFamily: "'Anton', sans-serif", lineHeight: "1.2" }}
              >
                THE HIGH-ALTITUDE THERMAL
              </h3>
              <p 
                className="text-white/90 text-sm normal-case tracking-widest mb-6 drop-shadow-sm" 
                style={{ fontFamily: "'Lato', sans-serif" }}
              >
                15-20 minutes of pure perspective.
              </p>
          ...
          {/* RIGHT: Landscape Polaroid Frame */}
          <div className="border-[6px] border-white bg-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.15)] shrink-0 opacity-100 rotate-0">
            <img
              ...
              alt="Thermal Mastery Paragliding"
            />
          </div>

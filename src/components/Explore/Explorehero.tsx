...
import heroBg from "@/assets/explorehero.jpg";
...
>
  We are your local wise guide at 5500m ASL
</p>
        {/* Description Text */}
        <p className="text-white text-lg md:text-lg font-lato max-w-2.5px mx-auto mb-10 leading-relaxed">
         This is the ridge line. For those who seek the view a chairlift can't give them. We provide the <br/> technical grit, the 30-year "beta," and the calculated risk required to face the peak. <br/> This is where you stop being a tourist and start being a seeker.
        </p>
